...
CREATE TABLE IF NOT EXISTS auth_user (
    ...
    create_time DATETIME NULL DEFAULT NULL COMMENT '[Create]新建时间',
    update_user_id BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '[Update]更新者 UserId',
    update_time DATETIME NULL DEFAULT NULL COMMENT '[Update]更新时间',
    ...
    last_change_pwd_time DATETIME NULL DEFAULT NULL COMMENT '最近修改密码时间',
    PRIMARY KEY (id)
) COMMENT '[User]Data';
...
CREATE TABLE IF NOT EXISTS auth_user_security (
    ...
    expire_time DATETIME NULL DEFAULT NULL COMMENT '有效时间',
