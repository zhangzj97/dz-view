...
const store = reactive({
  ...
  tableList : [
    ...
    { tableName: 'auth_user_extend'                , tableComment:'[User]ExtendVObj'        , type: 'VObj' },
    ...
    { tableName: 'auth_tenant_extend'              , tableComment:'[Tenant]ExtendVObj'      , type: 'VObj' },
    { tableName: 'auth_dept'                        , tableComment:'[Dept]Data'               , type: 'Tree' },
    { tableName: 'auth_dept_extend'                , tableComment:'[Dept]ExtendVObj'        , type: 'VObj' },
