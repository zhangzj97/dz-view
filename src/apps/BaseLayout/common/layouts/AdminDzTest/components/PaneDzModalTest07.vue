  ...
  <dz-modal :state="modalState" cache title="test01" icon="mdi:ab-testing">
    ...
    <template #footer>
      <v s="w-grow h-fit">
        ...
        <v s="w-12 h-8" class="bg-red-200"></v>
        <v s="w-12 h-8" class="bg-red-200"></v>
      </v>
    </template>
  </dz-modal>
