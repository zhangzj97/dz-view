...
// TODO 来自于Config
const LocalStorageKey = 'SourceAccessOtherDefault';
const LocalStorageStateKey = 'SourceAccessOtherState';
const StoreKey = 'SourceAccessOther';
const SourceFind = '/SourceAccessOther/Find';

// 自动获取 SourceRaw
const fileMap = {};
const SourceRaw = fileMap;

// request
const { request } = useRequest();

// useSource
export const useSourceOther = defineStore(
  StoreKey, //
  () => {
