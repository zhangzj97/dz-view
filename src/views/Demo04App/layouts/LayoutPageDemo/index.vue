...
<template>
  ...
  <dz-view col size="w-screen h-screen" overflow-hidden>
    <dz-view row size="h-16">
      <dz-view row size="w-grow"> </dz-view>
      <dz-view col size="w-grow">
        <dz-view col size="h-grow"></dz-view>
        <dz-view col size="h-grow"></dz-view>
      </dz-view>
    </dz-view>
    <dz-view row size="h-16"></dz-view>
    <dz-view row size="h-grow">
      <dz-view col size="w-64"></dz-view>
      <dz-view row size="w-grow"></dz-view>
      <dz-view col size="w-grow"> </dz-view>
      <dz-view col size="w-64"> </dz-view>
    </dz-view>
    <dz-view row size="h-16"></dz-view>
  </dz-view>
