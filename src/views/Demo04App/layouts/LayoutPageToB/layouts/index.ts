...
export const layoutData = [
  {
    ...
    children: [
      ...
      // 应用 Navbar
      { option: { layout: 'row', size: 'h-16' }, component: () => Layout300AppNavBar },
      // 粘性应用 Navbar
      // {
      ...
      // 主体
      {
        ...
        children: [
          ...
          { option: { layout: 'one', size: 'w-64' }, component: () => Layout404Left },
          {
            ...
            children: [
              { option: { layout: 'row', size: 'h-16' }, component: () => Layout405AppNavBar },
              { option: { layout: 'one', size: 'h-16' }, component: () => Layout406BreadCrumb },
              { option: { layout: 'one', size: 'h-grow' }, slot: true },
            ],
          },
