...
<template>
  <DzFlex @mouseleave="hiddenChildrenContainer" class="h-full">
    <DzFlex class="h-full overflow-y-auto">
    ...
    <DzFlex class="absolute top-0 shadow-lg left-full" v-show="!!menuState.activeId"
      v-if="menuState.activeChildrenList?.length > 0" @mouseleave="hiddenChildrenContainer">
      <DzFlex class="top-0 bg-slate-300" :style="{ height: 'calc(100vh - 128px)' }">
