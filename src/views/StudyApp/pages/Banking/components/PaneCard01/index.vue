    ...
    <div class="flex">
      ...
      <div class="flex items-center justify-end flex-grow">
        <div class="flex flex-col items-center mr-2">
          <div class="w-8 -mb-2">
            <DzIcon class="text-green-500" icon="mdi:menu-up" />
          </div>
          <div>
            <div class="font-bold text-green-500">+13%</div>
          </div>
        </div>
        <div>
          <div class="text-3xl font-bold">$4,000</div>
        </div>
      </div>
    </div>
    <ChartBar />
